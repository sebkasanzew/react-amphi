...
const nextFiles = ['**/*.{js,jsx,ts,tsx,mjs,mts}']
...
const eslintConfig = defineConfig([
  ...
  gitignore(),
  ...fixupConfigRules(nextVitals).map((c) => ({ ...c, files: c.files ?? nextFiles })),
  ...fixupConfigRules(nextTs).map((c) => ({ ...c, files: c.files ?? nextFiles })),
